...
public class Tutorial_Platform_1: IObject
{
    ...
    public Tutorial_Platform_1()
    {
        Sprite = SpriteFactory.Instance.CreateTutorial_Platform_1Sprite(position);
    }

     public Tutorial_Platform_1(Vector2 pos)
    {
        position = pos;
        Sprite = SpriteFactory.Instance.CreateTutorial_Platform_1Sprite(position);
    }
