...
public class Tutorial_Platform_7: IObject
{
    ...
    public Tutorial_Platform_7()
    {
        Sprite = SpriteFactory.Instance.CreateTutorial_Platform_7Sprite(position);
    }

    public Tutorial_Platform_7(Vector2 pos)
    {
        position = pos;
        Sprite = SpriteFactory.Instance.CreateTutorial_Platform_7Sprite(position);
    }
