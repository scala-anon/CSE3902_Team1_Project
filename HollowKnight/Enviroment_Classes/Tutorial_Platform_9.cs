...
public class Tutorial_Platform_9: IObject
{
    ...
    public Tutorial_Platform_9()
    {
        Sprite = SpriteFactory.Instance.CreateTutorial_Platform_9Sprite(position);
    }

    public Tutorial_Platform_9(Vector2 pos)
    {
        position = pos;
        Sprite = SpriteFactory.Instance.CreateTutorial_Platform_9Sprite(position);
    }
