...
namespace HollowKnight.Builders
{
    public static class KnightSpriteBuilder
    {
        public static Dictionary<KnightSpriteType, ISprite> BuildKnightSprites(Vector2 position)
        {
            return new Dictionary<KnightSpriteType, ISprite>
            {
                ...
                [KnightSpriteType.SideSlash] = SpriteFactory.Instance.CreateKnightSideSlashSprite(position),
                [KnightSpriteType.UpSlash] = SpriteFactory.Instance.CreateKnightUpSlashSprite(position),
                [KnightSpriteType.DownSlash] = SpriteFactory.Instance.CreateKnightDownSlashSprite(position),
